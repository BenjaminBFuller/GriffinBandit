...
void wait(int sec) // makes terminal wait X seconds, used before executing next function
...
void space() // clears the screen, similar to "clear" in bash
{
...
int main()
{
    ...
    cout << "You stole a Griffin"; ellipse(); cout << endl;
